...
export function UploadBox({
  ...
  return (
    ...
    >
      <Upload className="mx-auto mb-3 text-teal-700" />
      <h2 className="font-semibold">Upload a research PDF</h2>
      <p className="mt-1 text-sm text-stone-500">PDF, up to 50 MB</p>
      <button
        disabled={busy}
        onClick={() => ref.current?.click()}
        className="mt-5 rounded-lg bg-teal-700 px-4 py-2 text-white focus:outline-2"
      >
