...
\midrule
Text generation & \texttt{google/gemma-4-26b-a4b-it:free} & Ordered free models: Gemma 4 31B, GPT-OSS 20B, Nemotron Nano 9B V2, then \texttt{openrouter/free}.\\
Vision and handwriting & \texttt{google/gemma-4-26b-a4b-it:free} & The same ordered route, with OpenRouter selecting a compatible free endpoint.\\
...
Speech synthesis & \texttt{fish-audio/s2.1-pro-free:free} through OpenRouter & Local Kokoro JS, then browser SpeechSynthesis when server audio is unavailable.\\
